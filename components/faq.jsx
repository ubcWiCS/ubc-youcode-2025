...
const FaqItem = ({ question, answer, isOpen, onClick }) => {
  ...
  return (
    <div className="mb-[6px] md:mb-4 flex flex-col ">
      <button
        onClick={onClick}
        className="text-[7px] border border-white border-2 md:text-xs lg:text-lg flex justify-between items-center w-full px-5 py-[2px] md:px-6  md:py-[5px] lg:py-3 text-left text-white md:font-semibold bg-accent-magenta/[0.7] rounded-3xl hover:bg-teal focus:outline-none focus:ring-2 focus:ring-teal"
      >
        {question}
...
const FaqSection = () => {
  ...
  const handleItemClick = index => {
    ...
    return (
      <div className=" p-3 md:p-6 lg:p-14 md:mt-20 lg:mt-40 rounded-3xl  my-10 mx-auto max-w-6xl xl:mt-60" id="faq">
