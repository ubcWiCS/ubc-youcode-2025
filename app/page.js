...
export default function Home() {
  ...
  const yMidCity = useTransform(scrollYProgress, [0.2,0.4], [2*vh, 1.6*vh])
  const yFrontCity = useTransform(scrollYProgress, [0.4, 0.7], [3*vh, 2.3*vh])
  const yBottomBuildings = useTransform(scrollYProgress, [0.7, 1], [6*vh, 4.5*vh])
